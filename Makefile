...
PKG_SOURCES	=  tclstbimage.c
PKG_OBJECTS	=  tclstbimage.o
...
PKG_LIB_FILE	= libstbimage0.3.so
PKG_LIB_FILE8	= libstbimage0.3.so
PKG_LIB_FILE9	= libtcl9stbimage0.3.so
PKG_STUB_LIB_FILE = libstbimagestub0.3.a
...
top_builddir	= /home/danilo/Public/tcl-stbimage
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"stbimage\" -DPACKAGE_TARNAME=\"stbimage\" -DPACKAGE_VERSION=\"0.3\" -DPACKAGE_STRING=\"stbimage\ 0.3\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_stbimage=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -D_LARGEFILE64_SOURCE=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"stbimage\" -DPACKAGE_TARNAME=\"stbimage\" -DPACKAGE_VERSION=\"0.3\" -DPACKAGE_STRING=\"stbimage\ 0.3\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_stbimage=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -D_LARGEFILE64_SOURCE=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 $(PKG_CFLAGS)
